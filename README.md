...
## API Endpoints เพื่อทดสอบการทำงานของระบบ

### GET /

**วัตถุประสงค์**: เมื่อผู้ใช้เข้าถึง URL หลัก ("/") ของแอปพลิเคชัน จะได้รับการตอบกลับเป็นข้อความ "Hello Gofiber!" เพื่อทดสอบว่าเซิร์ฟเวอร์ทำงานได้ปกติและตอบกลับ HTTP ได้หรือไม่.

**การทำงาน**: เมื่อผู้ใช้เข้า URL นี้, เซิร์ฟเวอร์จะส่งข้อความ "Hello Gofiber!" ไปยังผู้ใช้.

### GET /testdb

**วัตถุประสงค์**: ใช้ทดสอบการเชื่อมต่อกับฐานข้อมูล (Database) เพื่อให้แน่ใจว่าเซิร์ฟเวอร์สามารถเชื่อมต่อกับฐานข้อมูลได้สำเร็จ.
...
**วัตถุประสงค์**: ดึงข้อมูลผู้ใช้ทั้งหมดจากระบบ (อ่านข้อมูลผู้ใช้).
...
**วัตถุประสงค์**: อัปเดตข้อมูลผู้ใช้.
...
**วัตถุประสงค์**: ลบข้อมูลผู้ใช้จากระบบ.
